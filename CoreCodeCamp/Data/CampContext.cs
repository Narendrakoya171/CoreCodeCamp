...
namespace CoreCodeCamp.Data
{
    public class CampContext:DbContext 
    {
        ...
        public DbSet<Talk> Talks { set; get; }
        public DbSet<Location> Locations { get; set; }

        protected override void OnConfiguring(  DbContextOptionsBuilder optionsBuilderlder)
        {
            optionsBuilderlder.UseSqlServer(_config.GetConnectionString("CodeCamp"));
        }
